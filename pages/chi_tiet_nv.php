        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                            ...
                            <form method="post">
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="gioitinh" class="form-control" readonly='true' value="<?php echo $gt ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="ngay" class="form-control" value="<?php echo $ngaysinh ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="que" class="form-control" value="<?php echo $que ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" name="sdt" required data-inputmask="'mask': ['999-999-9999 [x99999]', '+099 99 99 9999[9]-9999']" data-mask value="0<?php echo $sdt ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <label>Bộ phận</label>
                                            <select name="bophan" id="bophan" value="<?php echo $bophan ?>" class="form-control">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select name="calam" id="calam" required class="form-control">
                                                <option value="<?php echo $start . ' đến ' . $end ?>"><?php echo $start . ' đến ' . $end ?></option>
                                ...
                                <div class="row mb-2">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                <input name='luong' class="form-control" readonly value="<?php echo number_format($luong) ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="ngay_lam" value="<?php echo $ngaylam ?>" class="form-control datetimepicker-input" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-2">
                                ...
                                if (isset($_POST['btn'])) {
                                    ...
                                    $sql = "UPDATE nhan_vien SET Hoten='$ten',Ngaysinh='$ngaysinh',Quequan='$que',SDT='$sdt',ID_bophan='$bophan',ID_ca_lam='$calam',He_so_luong='$luong',Ngaylamviec='$ngaylam' WHERE Ma_nv='$manv'";
                    ...
                    <!-- <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><b>Tổng lương</b> </h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
